...
const ContactCTA: React.FC<ContactCTAProps> = ({ email, linkedin, telegram }) => {
  const contactContent = CONFIG.content.contact;
  
  return (
    <div className="contact-cta-container">
      <div className="contact-cta-content">
        <h2 className="contact-cta-title">{contactContent.title}</h2>
        ...
        <div className="contact-cta-buttons">
          ...
          {linkedin && (
            ...
            >
              ...
              {contactContent.buttons.linkedin}
            </a>
          )}
          ...
          {telegram && (
            ...
            >
              ...
              {contactContent.buttons.telegram}
            </a>
          )}
        </div>
